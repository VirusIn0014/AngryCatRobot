...
PM_START_TEXT = """Hey there, my name is ▵AngryCat▵.\n\nI am a next gen powerful group manager bot.\n\nHit /help to find my list of available commands."""
buttons = [
    [
        InlineKeyboardButton(text="♞ Support", url="https://t.me/Its_Vaib"),
        InlineKeyboardButton(text="❔ Help", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
            text="#⃣ Source Code", url="Lol"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add me to your group ➕", url="t.me/AngryCatRobot?startgroup=true"
        ),
    ],
]

HELP_STRINGS = """
Hey there! My name is *▵AngryCat▵*.
